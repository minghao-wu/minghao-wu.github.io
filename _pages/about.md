...
* **Language Agents**: My primary research interest is currently focused on multi-agent communication and collaboration. My recent work ([Wu et al., 2025](https://arxiv.org/abs/2405.11804)) proposed a multi-agent framework that mimics human translation workflows using language agents, achieving state-of-the-art results in literary translation tasks. My coauthors and I have also explored multi-agent collaboration for long document summarization ([Wang et al., 2025](https://arxiv.org/abs/2509.20900)).
